...
def regex(textfile):
	...
	funfile = open(textfile, 'w', encoding =('utf-8-sig')) #opening the file in write mode
...
def textpress(url, title="titre", year=1827, month=1, day=1, item=5, rate=1, lastpage=1):
...
textpress(url="https://gallica.bnf.fr/ark:/12148/cb34359823h/date", title="bulletinsdemedecinelegale", year=1826, month=1, day=1, item=361, rate=1, lastpage=11)
